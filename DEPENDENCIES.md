...
- Runa: vendored under `third_party/Runa` at commit
  `4dd00c541c374938b192e23dc2efa983748a92ab` (the repository's v1.2.3
  line). The adapter uses `font_load`, `layout_paragraph`, `line_destroy` and
  `cache_make/cache_size/cache_destroy`; the GUI does not expose Runa's atlas
  representation.
